...
export const TablaUsuario: React.FC<CrudGridProps> = ({ columns, initialRows, entityName, onEdit}) => {
  ...
  //Para que cuando se recargue la pagina muestre los datos.
  useEffect(() => {
    setRows(initialRows);
  ...
  return (
    ...
    />
      ...
      <Dialog open={openDeleteDialog} onClose={() => setOpenDeleteDialog(false)}>
        ...
        <DialogContent>
          Estás seguro que desea eliminar a "{selectedRow?.nombre} {selectedRow?.apellido}"?
        </DialogContent>
        <DialogActions>
...
<Dialog open={openViewDialog} onClose={() => setOpenViewDialog(false)}>
  <DialogTitle>Visualización</DialogTitle>
  <DialogContent>
    {columns
